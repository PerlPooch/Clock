...
#ifndef WIFI_CONFIG_NAME
#define WIFI_CONFIG_NAME	"OSCR"
#endif
...
class MDS_AutoWiFi {
	public:
        MDS_AutoWiFi();
        ~MDS_AutoWiFi();
		void 					setup(bool shouldResetWiFI);
		...
		char*					getSystemID();
		void					setConfigMQTTName(String b);
		String					getConfigMQTTName();
		...
		void					setSaveConfigCallback(std::function<void(String, String, String)> callback);
		void					tick();
...
// 		AutoConnect*			Portal;
		...
		MDS_Display*			display;
		String					config_MQTTName;
		String					config_MQTTBroker;
		String					config_MQTTPort;
		std::function<void(String, String, String)> saveCallback;
		void 					setMAC();
};
